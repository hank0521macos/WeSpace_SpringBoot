...
<!-- ---------------------------------新增空間的form1表單--------------------------------- -->        
        <form action="/updateSpace" method="post" id="form1" enctype="multipart/form-data">
        <!--  --------------------空間類型-------------------- -->
        ...
        <!--  --------------------定價-------------------- -->
           ...
           <!--  這個是給更新用form1表單取得指定空間id的input標籤，在下方更新按鈕submit後即可為指定空間更新 -->
            <input type="hidden" name="id" id="facilitiesId" value="${facilitiesRecord.id}">
		</form>
